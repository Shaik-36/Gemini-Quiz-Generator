    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                num_questions= st.slider("Enter the Number of Questions:", min_value=1, max_value=10, value=5)
                ...
                if submitted:
                    ...
                    generator = QuizGenerator(topic_input, num_questions, chroma_creator) # Step 3: Initialize a QuizGenerator class using the topic, number of questrions, and the chroma collection
